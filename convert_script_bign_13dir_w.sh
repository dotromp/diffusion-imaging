...
echo mri_convert ${raw}/${dti} ${PROCESS}/DTI_RAW/${i}_dti.nii;
mri_convert ${raw}/${dti} ${PROCESS}/DTI_RAW/${i}_dti.nii;

echo CONVERT 2DFAST
echo Scan is ${twodfast}
#convert_file ${raw}/${twodfast} ${PROCESS}/2DFAST/${i}_2dfast nii;
echo mri_convert ${raw}/${twodfast} ${PROCESS}/2DFAST/${i}_2dfast.nii;
mri_convert ${raw}/${twodfast} ${PROCESS}/2DFAST/${i}_2dfast.nii;
