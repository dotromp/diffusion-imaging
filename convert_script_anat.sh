...
echo
echo Convert T1, T2 from DICOM to NIfTI for multiple subjects
echo Usage:
echo sh convert_script_anat.sh {raw_input_dir} {process_dir} {subjs_separate_by_space}
echo eg:
echo
echo convert_script_anat.sh /study/mri/raw-data /study5/aa-scratch/MRI 002 003 004 
echo
